...
def main():
    ...
    if len(sys.argv) > 3:
        ...
        original_time = input("Enter the original time (YYYY-MM-DD HH:MM:SS): ")
        print("\nPlease use the IANA time zone formate. Use the TZ identifier for the time zone input.\n")
    ...
    print(f"\x1b[32mThe time in {to_time_zone} is \x1b[11;30;42m{formatted_time}\x1b[0m")
